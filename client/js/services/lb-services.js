 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Reviewers/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Reviewer.answers.findById() instead.
            "prototype$__findById__answers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Reviewers/:id/answers/:fk",
              method: "GET",
            },

            // INTERNAL. Use Reviewer.answers.destroyById() instead.
            ...
            // INTERNAL. Use Reviewer.answers.updateById() instead.
            ...
            // INTERNAL. Use Reviewer.answers() instead.
            "prototype$__get__answers": {
              isArray: true,
              url: urlBase + "/Reviewers/:id/answers",
              method: "GET",
            },

            // INTERNAL. Use Reviewer.answers.create() instead.
            "prototype$__create__answers": {
              url: urlBase + "/Reviewers/:id/answers",
              method: "POST",
            },

            // INTERNAL. Use Reviewer.answers.destroyAll() instead.
            "prototype$__delete__answers": {
              url: urlBase + "/Reviewers/:id/answers",
              method: "DELETE",
            },

            // INTERNAL. Use Reviewer.answers.count() instead.
            "prototype$__count__answers": {
              url: urlBase + "/Reviewers/:id/answers/count",
              method: "GET",
            },
            ...
            // INTERNAL. Use Answer.reviewer() instead.
            "::get::Answer::reviewer": {
              url: urlBase + "/Answers/:id/reviewer",
              method: "GET",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.Reviewer.answers
     * @header lbServices.Reviewer.answers
     * @object
     * @description
     *
     * The object `Reviewer.answers` groups methods
     * manipulating `Answer` instances related to `Reviewer`.
     *
     * Call {@link lbServices.Reviewer#answers Reviewer.answers()}
     * to query all related instances.
     */
        ...
        R.answers = function() {
          ...
          var action = TargetResource["::get::Reviewer::answers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.answers#count
             * @methodOf lbServices.Reviewer.answers
             *
             * @description
             *
             * Counts answers of Reviewer.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Reviewer id
        ...
        R.answers.count = function() {
          var TargetResource = $injector.get("Answer");
          var action = TargetResource["::count::Reviewer::answers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.answers#create
             * @methodOf lbServices.Reviewer.answers
             *
             * @description
             *
        ...
        R.answers.create = function() {
          var TargetResource = $injector.get("Answer");
          var action = TargetResource["::create::Reviewer::answers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.answers#createMany
             * @methodOf lbServices.Reviewer.answers
             *
             * @description
             *
        ...
        R.answers.createMany = function() {
          var TargetResource = $injector.get("Answer");
          var action = TargetResource["::createMany::Reviewer::answers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.answers#destroyAll
             * @methodOf lbServices.Reviewer.answers
             *
             * @description
             *
        ...
        R.answers.destroyAll = function() {
          var TargetResource = $injector.get("Answer");
          var action = TargetResource["::delete::Reviewer::answers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.answers#destroyById
             * @methodOf lbServices.Reviewer.answers
             *
             * @description
             *
        ...
        R.answers.destroyById = function() {
          var TargetResource = $injector.get("Answer");
          var action = TargetResource["::destroyById::Reviewer::answers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.answers#findById
             * @methodOf lbServices.Reviewer.answers
             *
             * @description
             *
        ...
        R.answers.findById = function() {
          var TargetResource = $injector.get("Answer");
          var action = TargetResource["::findById::Reviewer::answers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.answers#updateById
             * @methodOf lbServices.Reviewer.answers
             *
             * @description
             *
        ...
        R.answers.updateById = function() {
          var TargetResource = $injector.get("Answer");
          var action = TargetResource["::updateById::Reviewer::answers"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Categories/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Survey.category() instead.
            "::get::Survey::category": {
              url: urlBase + "/Surveys/:id/category",
              method: "GET",
            },
          }
        );
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Surveys/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Survey#patchOrCreate
             * @methodOf lbServices.Survey
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Survey#replaceOrCreate
             * @methodOf lbServices.Survey
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/Surveys/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Survey#upsertWithWhere
             * @methodOf lbServices.Survey
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/Surveys/upsertWithWhere",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Survey#replaceById
             * @methodOf lbServices.Survey
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/Surveys/:id/replace",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Survey#prototype$patchAttributes
             * @methodOf lbServices.Survey
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Survey#createChangeStream
             * @methodOf lbServices.Survey
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/Surveys/change-stream",
              method: "POST",
            },
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Survey#patchOrCreateWithWhere
             * @methodOf lbServices.Survey
             *
             * @description
             *
        ...
        */
        R.modelName = "Survey";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Survey#category
             * @methodOf lbServices.Survey
             *
             * @description
             *
        ...
        R.category = function() {
          ...
          var action = TargetResource["::get::Survey::category"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Answers/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Answer#prototype$patchAttributes
             * @methodOf lbServices.Answer
             *
             * @description
             *
            ...
            // INTERNAL. Use Reviewer.answers.create() instead.
            "::create::Reviewer::answers": {
              url: urlBase + "/Reviewers/:id/answers",
              method: "POST",
            },

            // INTERNAL. Use Reviewer.answers.createMany() instead.
            "::createMany::Reviewer::answers": {
              isArray: true,
              url: urlBase + "/Reviewers/:id/answers",
              method: "POST",
            },
            ...
            // INTERNAL. Use Reviewer.answers.destroyAll() instead.
            "::delete::Reviewer::answers": {
              url: urlBase + "/Reviewers/:id/answers",
              method: "DELETE",
            },

            // INTERNAL. Use Reviewer.answers.count() instead.
            "::count::Reviewer::answers": {
              url: urlBase + "/Reviewers/:id/answers/count",
              method: "GET",
            },
          }
        ...
        */
        R.modelName = "Answer";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Answer#reviewer
             * @methodOf lbServices.Answer
             *
             * @description
             *
        ...
        R.reviewer = function() {
          var TargetResource = $injector.get("Reviewer");
          var action = TargetResource["::get::Answer::reviewer"];
          return action.apply(R, arguments);
        };
